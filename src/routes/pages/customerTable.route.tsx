  ...
  return (
    <div className=''>
      <div className='w-full overflow-hidden rounded-lg shadow-xs'>
        ...
        <div className='w-full overflow-x-auto rounded-lg shadow-md drop-shadow-md'>
          <table className='w-full'>
            <thead>
              <tr className='text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-card-head'>
            ...
            <tbody className='bg-white divide-y dark:divide-gray-700 dark:bg-gray-800'>
              <tr className='hover:bg-card-assent-1 text-primary bg-card-1'>
              ...
              <tr className='hover:bg-card-assent-1 text-primary bg-card-2'>
                <td className='px-4 py-3'>
                  <div className='flex items-center text-sm'>
                    <div className='relative hidden w-8 h-8 mr-3 rounded-full md:block'>
                      <img
            ...
            <tfoot className='dark:divide-gray-700  text-primary bg-card-head'>
              <tr>
